    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.navy950 }}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.title}>Garage Sign In</Text>
          <Text style={styles.subtitle}>Access your garage dashboard</Text>
          <View style={styles.form}>
            <Input label="Email" value={email} onChangeText={setEmail} placeholder="you@garage.com" keyboardType="email-address" autoCapitalize="none" />
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 4 }}>
              ...
              <Text style={{ color: Colors.orange500, fontSize: 13 }} onPress={() => router.push('/(auth)/sign-up')}>
                {' '}Sign up
              </Text>
            </View>
          </View>
