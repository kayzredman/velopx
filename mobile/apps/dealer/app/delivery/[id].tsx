...
const MOCK_DELIVERY: DeliveryDetail = {
  id: 'mock-del-1',
  status: 'in_transit',
  orderId: 'mock-order-1',
  orderReference: 'VX-2024-001',
  estimatedMinutes: 25,
  distanceKm: 8.2,
...
export default function DeliveryTrackingScreen() {
  ...
  const driverLat = delivery.driver?.location?.lat ?? delivery.destination.lat - 0.01
  const driverLng = delivery.driver?.location?.lng ?? delivery.destination.lng - 0.01
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitles}>
          ...
          {delivery.orderReference ? (
            <Text style={styles.headerSub}>{delivery.orderReference}</Text>
          ) : null}
        </View>
      </View>
          ...
          {delivery.driver ? (
            <View style={styles.section}>
              ...
              <View style={styles.infoCard}>
                ...
                <Text style={styles.infoDetail}>{delivery.driver.phone}</Text>
