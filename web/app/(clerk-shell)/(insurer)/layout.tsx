...
const MAIN_NAV = [
  ...
  },
  {
    ...
    label: 'Claims',
    exact: false,
    icon: <Ico d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />,
    badge: null,
  },
  {
    href: '/insurer/assessors',
    label: 'Assessors',
    exact: false,
    icon: <Ico d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />,
    badge: null,
  },
  {
    href: '/insurer/deliveries',
    label: 'Deliveries',
    exact: false,
    ...
    <div className="min-h-screen bg-background flex">
      <aside className="portal-sidebar fixed top-0 left-0 z-40 flex h-screen w-[264px] flex-col border-r">
        <div className="border-b border-sidebar-border px-5 py-5 pl-6">
          <Link href="/insurer" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="mt-0.5 block text-[10px] uppercase leading-none tracking-widest text-rose-400/90">Insurer</span>
            </div>
          </Link>
        </div>
        ...
        <nav className="flex flex-1 flex-col gap-1 overflow-y-auto px-3 py-4 pl-4">
          ...
          <p className="mb-1 mt-5 px-3 text-[9px] font-bold uppercase tracking-[0.15em] text-sidebar-muted/80">Admin</p>
          {ADMIN_NAV.map((item) => (
            <NavItem key={item.href} item={item} />
          ))}
        </nav>
        ...
        <div className="flex items-center gap-3 border-t border-sidebar-border px-5 py-4 pl-6">
          ...
          <div className="min-w-0">
            <p className="truncate text-xs font-medium text-sidebar-foreground">Insurance Portal</p>
            <p className="truncate text-[10px] text-sidebar-muted">VelopX Insurer</p>
          </div>
        </div>
      </aside>
